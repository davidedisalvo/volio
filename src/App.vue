  ...
  methods: {
    ...
    enter: function(el, done) {
      ...
      Velocity(
        el,
        { opacity: 1 },
        { duration: 0, complete: window.scrollTo(0, 0) }
      );
      Velocity(
        b,
        { translateX: "100%" },
        { duration: 600, delay: 50, complete: done }
      );
    },
...
@import "/scss/variables", "/scss/global", "/scss/typography", "/scss/cards",
  "/scss/flickity", "/scss/dark", "/scss/media";
