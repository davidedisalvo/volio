  ...
  <nav id="navigationBar">
    <router-link to="/">
      <h4>
        ...
        <span class="invisible">avide &nbsp;</span>
        <span class="visible">S</span>
        <span class="invisible">imone &nbsp;</span>
        <span class="visible">D</span>
        <span class="invisible">i &nbsp;</span>
        <span class="visible">S</span>
        <span class="invisible">alvo &nbsp;</span>
      </h4>
    </router-link>
    <div class="social-box">
      <a href="https://github.com/davidedisalvo" class="social-icon" title="GitHub">
      ...
      <a href="mailto:davidesimone.disalvo@gmail.com" class="social-icon" title="Email">
        <svg viewBox="0 0 512 512" width="35" height="35" xmlns="http://www.w3.org/2000/svg">
          <path
            id="socialPath"
...
nav {
  ...
  background-color: hsl(222, 63%, 97%);
  padding: 0 5%;
  width: 100%;
  height: 64px;
  display: flex;
